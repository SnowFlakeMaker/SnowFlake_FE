        ...
        switch(endingType){
            ...
            case "스탯 엔딩" :
                if(endingText === "군인"){
                    ...
                    setSrc("/image/ending/status/social/endingimg_sociality_startup.PNG");
                }
                else if(endingText === "대통령"){
                    setText("꾸준히 사람들을 나서서 이끌다보니, 점점 더 큰 단위에서 문제를 바라볼 수 있었다. 훗날 한 국가를 이끄는 사람이 되었다.");
                    setSrc("/image/ending/status/leadership/endingimg_leadership_president.PNG");
                }
