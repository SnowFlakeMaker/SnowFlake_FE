    ...
    return(
        <Container>
            {isApply === undefined &&
                <>
                    <TextContainer>
                        <Text>해외의 다른 학교에서 학교생활을 할 수 있는 교환학생에 지원할까?</Text>
                    </TextContainer>

                    <SelectContainer>
                        <SelectOption onClick={()=>{setIsApply(true), postExchange();}}>지원한다. (Y)</SelectOption>
